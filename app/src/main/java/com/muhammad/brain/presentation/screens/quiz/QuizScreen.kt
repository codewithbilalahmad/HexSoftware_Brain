        ...
        when {
            ...
            state.quizQuestions.isNotEmpty() -> {
                AnimatedContent(targetState = state.showQuizResult, transitionSpec = {
                    ...
                    if (showQuizResult) {
                        val quizResultProgress = (state.correctQuestions.size.toFloat() / state.quizQuestions.size.toFloat())
                        ...
                        LazyColumn(
                            ...
                            item("QuizProgressSection") {
                                QuizProgressSection(
                                    ...
                                    timeLeft = state.timeLeft, isQuestionLocked = state.isAnswerLocked
                                )
                            }
